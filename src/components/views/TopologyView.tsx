  ...
  return (
    <div className="w-full h-full flex flex-col bg-gradient-to-br from-black/40 to-transparent p-6 gap-4 overflow-hidden">
      ...
      >
        ...
        <div>
          <h2 className="text-xl font-black text-white bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">CYBER SECURITY TOPOLOGY</h2>
          <p className="text-xs text-cyan-300">Advanced Global Network Intelligence & Threat Monitoring</p>
        </div>
      </motion.div>
