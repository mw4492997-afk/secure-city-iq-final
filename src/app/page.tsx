...
{activeTab === 'topology' && (
              ...
              >
                <div className="max-w-6xl mx-auto">
                  <h2 className="text-5xl lg:text-7xl font-black text-white tracking-[-0.05em] text-center mb-12 uppercase font-mono">Real-Time Node Topology</h2>
                  <p className="text-zinc-400 text-xl text-center mb-12 max-w-2xl mx-auto">Live visualization of your local network devices connected to Wasit Central Gateway</p>
                  <NodeTopology />
                </div>
              </motion.div>
            )}
