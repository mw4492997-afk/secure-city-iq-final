...
import { ShieldAlert, Globe, Server, Cpu, Activity, Zap, ShieldCheck } from "lucide-react";
      ...
      <main className="relative z-10 flex flex-col items-center w-full max-w-7xl px-6 pt-24 pb-48">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="flex flex-col gap-6">
            <div className="glass-card p-6 flex flex-col gap-6 flex-grow">
              <h3 className="text-sm font-black tracking-widest uppercase flex items-center gap-2">
                <ShieldCheck className="w-4 h-4 text-green-500" />
                Security Ledger
              </h3>
              <div className="flex flex-col gap-3">
                <LedgerItem time="12:44" event="Handshake Protocol" status="Success" />
                <LedgerItem time="12:40" event="IP Block: 45.22.11" status="Blocked" />
                <LedgerItem time="12:35" event="Node Sync" status="Complete" />
                <LedgerItem time="12:30" event="Database Backup" status="Stored" />
              </div>
